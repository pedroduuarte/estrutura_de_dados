...
public class Program {
	...
	public static void main(String[] args) {
		...
		System.out.println(listaCircular.imprime()); // 1 2 3 5 6 7
		listaCircular.remove(5, false);
		System.out.println(listaCircular.imprime()); // 1 2 3 6 7
		listaCircular.remove(7, false);
		System.out.println(listaCircular.imprime()); // 1 2 3 6
		System.out.println("==========================");
		listaCircular.insere(1);
		listaCircular.insere(1);
		System.out.println(listaCircular.imprime()); // 1 1 1 2 3 6 
		listaCircular.remove(1, true);
		System.out.println(listaCircular.imprime()); // 2 3 6
		listaCircular.insere(6);
		listaCircular.insere(6);
		listaCircular.insere(7);
		listaCircular.insere(7);
		...
		listaCircular.insere(4);
		listaCircular.insere(5);
		System.out.println(listaCircular.imprime()); // 2 3 4 4 5 6 6 6 7 7
		listaCircular.remove(4, true);
		System.out.println(listaCircular.imprime()); // 2 3 5 6 6 6 7 7
		listaCircular.remove(2, true);
		System.out.println(listaCircular.imprime()); // 3 5 6 6 6 7 7
